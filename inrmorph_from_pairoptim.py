...
from utils import PositionalEncoding, SpatialTransform, SmoothDeformationField, CoordsImageTest
...
# accoring to the paper, the activation function is sin(omega * alpha(x) * x), where alpha(x) = |x| + 1
